...
<body style="background-color: #2D882D">
...
<defs>
          ...
          <radialGradient cx="50%" cy="0%" fx="50%" fy="0%" r="50%" id="radialGradient-6">
            <stop stop-color="#ffea00" offset="0%"></stop>
            <stop stop-color="#6a1b9a" offset="100%"></stop>
          </radialGradient>
          <linearGradient x1="0%" y1="0%" x2="100%" y2="0%" id="radialGradient-7">
            <stop stop-color="#ff6d00" offset="16%"></stop>
            <stop stop-color="#1b5e20" offset="32%"></stop>
            <stop stop-color="#206EFF" offset="48%"></stop>
            <stop stop-color="#d50000" offset="64%"></stop>
            <stop stop-color="#ffea00" offset="80%"></stop>
            <stop stop-color="#6a1b9a" offset="100%"></stop>
          </linearGradient>
        </defs>
          ...
          <g id="fills" transform="translate(85.000000, 60.000000)">
            ...
            <path d="M413.79,10.81a51.05,51.05,0,0,1,59.6,0q17.4,12.8,17.4,37.8v4.6a14.6,14.6,0,1,1-29.2,0v-4.6q0-11-8.4-15.6a19.28,19.28,0,0,0-9.6-2.6,19.62,19.62,0,0,0-9.8,2.6q-8.4,4.6-8.4,15.6,0,10.8,8.4,15.4a20.34,20.34,0,0,0,9.8,2.6,49.42,49.42,0,0,1,29.8,9.6q17.4,12.8,17.4,37.6,0,24-16.4,36.8h25.8v10.6h-56.6v-10.6a40.21,40.21,0,0,0,18.8-4.8q17.8-9.2,17.8-32,0-22.6-17.8-31.8-7-3.6-19.4-4.8-28.2-2.6-28.2-28.6,0-12.6,8.1-20.7t20.7-8.1q12.6,0,20.6,8.1t8,20.7v4.6q0,4,4,4t4-4v-4.6q0-22.8-17.8-32a39.61,39.61,0,0,0-37.8,0q-17.8,9.2-17.8,32,0,22.6,17.8,31.8a40.59,40.59,0,0,0,19,4.8q12.4,0,20.5,8.1t8.1,20.5q0,12.6-8,20.7t-20.6,8.1q-12.6,0-20.7-8.1t-8.1-20.7v-9.2q0-4.2-4-4.2t-4,4.2v42a14.35,14.35,0,0,1-14.6,14.6h-5.4v-10.4l5.2-.2q4.2-.2,4.2-4v-42q0-6.6,4-10.6t10.6-4a13.75,13.75,0,0,1,14.6,14.6v9.2q0,11,8.4,15.6a19.23,19.23,0,0,0,9.6,2.6,19.61,19.61,0,0,0,9.8-2.6q8.4-4.6,8.4-15.6,0-10.8-8.4-15.4a20,20,0,0,0-9.6-2.6,49.41,49.41,0,0,1-29.8-9.6q-17.6-12.8-17.6-37.6Q396.19,23.61,413.79,10.81Z" id="fill-s-2" fill="#88CC88"></path>
,0,0,1-10.5,4.2H855q-4.2,0-4.2,4t4.2,4h89.2v10.6H855a14.55,14.55,0,0,1-10.6-4.1,15.22,15.22,0,0,1,0-21A14.56,14.56,0,0,1,855,132h65.2q4.2,0,4.2-3.9,0-4.1-4.2-4.1h-56a23.2,23.2,0,0,1-17.2-6.86q-6.8-6.85-6.8-17.34T847,82.57q6.8-6.76,17.2-6.76h37.4q4,0,4-4.1,0-3.9-4-3.9h-37.4q-10.4,0-17.2-6.8t-6.8-17.2q0-10.4,6.8-17.2t17.2-6.8h56q4.2,0,4.2-4t-4.2-4h-88v134.8a14,14,0,0,1-14.6,14.6h-5.4v-10.6h5.2q4.2-.2,4.2-4V1.21Z" id="fill-e" fill="#88CC88"></path>
        ...
        <div class="row">
            <div class="panel panel-info">
                <div style="background-color:white;" class="panel-heading">
                    <h3 class="panel-title">Editar periódico</h3>
                </div>
                <div class="panel-body">
                    <form id="form-periodico" method="POST" action="/periodicos/{{$periodico->id}}" enctype="multipart/form-data" class="col s12">
                        {{ csrf_field() }}
                        <input type="hidden" name="_method" value="PUT">
                        <div class="row">
                            <div class="input-field col s6">
                                <input placeholder="Digite o título do periódico" name="titulo" id="titulo" type="text" class="validate" value="{{ $periodico->titulo }}">
                                <label for="titulo">Título</label>
                            </div>
                            <div class="input-field col s6">
                                <input placeholder="Digite o ISSN" name="issn" id="issn" pattern="[0-9][0-9][0-9][0-9][-][0-9][0-9][0-9][X0-9]" type="text" class="validate" value="{{ $periodico->issn }}" >
...
<div class="input-field col s6">
                        <select name="area_atuacao" id="area_atuacao" class="validate">
                                <option value="{{$periodico->area_atuacao}}">{{$periodico->area_atuacao}}</option>
                        ...
                        <div class="input-field col s3">
                            <select id="fator_impacto" name="fator_impacto">
                                <option value="{{$periodico->fator_impacto}}">{{str_replace(";", " até ", $periodico->fator_impacto)}}</option>
                        ...
                        <div class="input-field col s3">
                            <select id="qualis" name="qualis">
                              <option value="{{$periodico->qualis}}">{{$periodico->qualis}}</option>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <textarea id="descricao" name="descricao" class="materialize-textarea" value="{{ $periodico->descricao }}" >{{$periodico->descricao}}</textarea>
                            <label for="descricao">Descrição</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12">
                            <input type="submit" name="salvar" class="btn green" value="Salvar">
                            <a href="/periodicos/{{$periodico->id}}" type="button" class="btn btn-sm red">Cancelar</a>
                        </div>
                    </div>
                    </div>
                  </form>
...
<script src="{{ asset('js/editPeriodicos.js') }}"></script>
