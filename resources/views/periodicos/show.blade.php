        ...
        <div class="row">
            <div class="panel panel-info">
                <div style="background-color:white;" class="panel-heading">
                    <h3 class="panel-title">Visualizar periódico</h3>
                </div>
                    ...
                    <form id="form-periodico" method="POST" action="/periodicos" enctype="multipart/form-data" class="col s12">
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                                <input placeholder="Digite o título do periódico" name="titulo" id="titulo" type="text" class="validate" readonly="readonly" value="{{ $periodico->titulo }}">
                                <label for="titulo">Título</label>
                            </div>
                            <div class="input-field col s6">
                                <input placeholder="Digite o ISSN" name="issn" id="issn" pattern="[0-9][0-9][0-9][0-9][-][0-9][0-9][0-9][X0-9]" type="text" class="validate" value="{{ $periodico->issn }}" readonly="readonly">
                                <label for="issn">ISSN</label>
                            </div>
                        </div>
                        <div class="row">
<div class="input-field col s6">
                            <input name="area_atuacao" id="area_atuacao" type="text" class="validate" value="{{ $periodico->area_atuacao }}" readonly="readonly">
                            <label for="area_atuacao">Área de atuação</label>
                        </div>
                        <div class="input-field col s3">
                            <input name="fator_impacto" id="fator_impacto" type="text" class="validate" value="{{str_replace(";", " até ", $periodico->fator_impacto)}}" readonly="readonly">
                            <label for="fator_impacto">Fator de impacto</label>
                        </div>
                        <div class="input-field col s3">
                            <input name="qualis" id="qualis" type="text" class="validate" value="{{ $periodico->qualis }}" readonly="readonly">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            @if($periodico->user_id == Auth::user()->id)
                              <a href="/periodicos/{{ $periodico->id }}/edit" class="btn">EDITAR PERIÓDICO</a>
                            @endif
                            <a href="/publicacoes/periodico/{{ $periodico->id }}" class="btn blue">VISUALIZAR PUBLICAÇÕES</a>
                        </div>
                    </div>
                    </div>
            </div>
...
<script src="{{ asset('js/showPeriodicos.js') }}"></script>
